...
//  }
  ...
  "BatchProducer.processOneBatch" should {
    "filter and save a batch of trasaction, wait 59 mn, fetch the next batch" in withTempDir { tmpDir =>
      ...
      // Finally, we can check that the right transactions were saved to disk
